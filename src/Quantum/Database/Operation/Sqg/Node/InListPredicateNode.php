...
final class InListPredicateNode implements SemanticNode
{
    use SemanticNodeTrait;

    /** @param list<SemanticNode> $list */
    ...
    public function kind(): SemanticNodeKind { return SemanticNodeKind::InList; }
    public function children(): array { return array_merge([$this->operand], array_values($this->list)); }
