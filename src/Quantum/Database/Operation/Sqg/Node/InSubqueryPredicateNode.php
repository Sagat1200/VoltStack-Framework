...
final class InSubqueryPredicateNode implements SemanticNode
{
    ...
    public function kind(): SemanticNodeKind { return SemanticNodeKind::InSubquery; }
    public function children(): array { return [$this->operand, $this->subquery]; }
