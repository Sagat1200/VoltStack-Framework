...
final class UpdateAssignmentNode implements SemanticNode
{
    use SemanticNodeTrait;

    public function __construct(
        public readonly string $column,
        public readonly SemanticNode $value,
        ?string $id = null, int $flags = 0, ?\Quantum\Database\Operation\Sqg\SourceSpan $span = null,
    ) { $this->initNode($id, $flags, $span); }

    public function kind(): SemanticNodeKind { return SemanticNodeKind::UpdateAssignment; }
    public function children(): array { return [$this->value]; }
