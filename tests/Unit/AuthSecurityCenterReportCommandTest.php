...
PHP
    ...
    public function test_it_emits_longitudinal_metrics_from_audit_log_source_in_json_and_export(): void
    {
        ...
        self::assertSame(
            [
                ...
                'delegated_support:self_governed_full->sessions_only',
                'delegated_support:self_governed_sessions->sessions_only',
                'delegated_support:self_governed_trusted_devices->deny_all',
                'untrusted:*->deny_all',
            ],
        ...
        self::assertSame(
            'distributed_recent_lag_guard_delegated_admin_policy',
        ...
        self::assertSame(
            'distributed_recent_lag_guard_delegated_support_delegated_target_policy',
        ...
        self::assertSame(
            'deny_all',
            $payload['longitudinal_metrics']['activity_drift']['operational_response']['authorization_mode_scope_policies']['delegated_admin']['privilege_scope_policies']['delegated_support']['target_relation_scope_policies']['self_governed']['target_scope_relation_policies']['self_governed_trusted_devices_scope_target']['remote_mutation_scope_policy'] ?? null,
        );
        self::assertSame(
            'distributed_recent_lag_guard_delegated_support_self_governed_trusted_target_policy',
            $payload['longitudinal_metrics']['activity_drift']['operational_response']['authorization_mode_scope_policies']['delegated_admin']['privilege_scope_policies']['delegated_support']['target_relation_scope_policies']['self_governed']['target_scope_relation_policies']['self_governed_trusted_devices_scope_target']['policy_reason_code'] ?? null,
        );
        self::assertSame(
            'deny_all',
        ...
        self::assertSame(
            'fingerprint-a',
            $payload['longitudinal_metrics']['activity_drift']['operational_response']['target_store_assessments'][0]['store_fingerprint'] ?? null,
        );
        self::assertSame(
            'lagging',
            $payload['longitudinal_metrics']['activity_drift']['operational_response']['target_store_assessments'][0]['status'] ?? null,
        );
    ...
    public function test_it_derives_a_guarded_observability_response_for_concentrated_activity(): void
    {
        ...
        self::assertSame(
            ['trusted-devices'],
            $payload['longitudinal_metrics']['activity_drift']['operational_response']['authorization_mode_scope_policies']['delegated_admin']['privilege_scope_policies']['delegated_support']['target_relation_scope_policies']['self_governed']['target_scope_relation_policies']['self_governed_trusted_devices_scope_target']['allowed_remote_mutation_scopes'] ?? null,
        );
        self::assertSame(
    ...
    public function test_it_derives_a_scope_guarded_operational_response_for_partial_visibility(): void
    {
        ...
        self::assertSame(
            'sessions_only',
            $payload['longitudinal_metrics']['activity_drift']['operational_response']['authorization_mode_scope_policies']['delegated_admin']['privilege_scope_policies']['delegated_support']['target_relation_scope_policies']['delegated_administrative_target']['target_scope_relation_policies']['delegated_admin_sessions_scope_target']['remote_mutation_scope_policy'] ?? null,
        );
        self::assertSame(
            ['sessions'],
            $payload['longitudinal_metrics']['activity_drift']['operational_response']['authorization_mode_scope_policies']['delegated_admin']['privilege_scope_policies']['delegated_support']['target_relation_scope_policies']['delegated_administrative_target']['target_scope_relation_policies']['delegated_admin_sessions_scope_target']['allowed_remote_mutation_scopes'] ?? null,
        );
        self::assertSame(
            'distributed_partial_visibility_guard_delegated_support_delegated_sessions_target_policy',
            $payload['longitudinal_metrics']['activity_drift']['operational_response']['authorization_mode_scope_policies']['delegated_admin']['privilege_scope_policies']['delegated_support']['target_relation_scope_policies']['delegated_administrative_target']['target_scope_relation_policies']['delegated_admin_sessions_scope_target']['policy_reason_code'] ?? null,
        );
