...
use Quantum\Database\Operation\Sqg\Enum\OrderDirection;
...
final class OrderByListNode implements SemanticNode
{
    use SemanticNodeTrait;

    /** @param list<OrderByItemNode> $items */
    public function __construct(
        public readonly array $items,
        ?string $id = null, int $flags = 0, ?\Quantum\Database\Operation\Sqg\SourceSpan $span = null,
    ) { $this->initNode($id, $flags, $span); }

    public function kind(): SemanticNodeKind { return SemanticNodeKind::OrderByList; }
